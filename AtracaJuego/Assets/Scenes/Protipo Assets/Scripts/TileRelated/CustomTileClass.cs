        ...
        switch(effect){ //0=None 1=Gas 2=Fire 3=Push 4=Ice 5=Elec //Especiales 6=Wet
            ...
            case 2:
                    ...
                    switch(tileEffect){
                        ...
                        case 5: AddEffectAct(3,og,bypass,lock_,2,3,null,_PT.wetT,2,2,direction,1); break;//tileEffect=2; tileFadeEffect=3;  _PT.Gas.SetTile(tilePos+og,null); _PT.Charco.SetTile(tilePos+og,_PT.wetT); if(bypass){_MM.SpreadEffectLimit(tilePos.x,tilePos.y,2,0,1,0,lock_);} break;
                        ...
                        case 14: AddEffectAct(7,og,bypass,lock_,11,3,null,null,2,2,direction,1); break;//tileEffect=11; tileFadeEffect=3;_PT.Gas.SetTile(tilePos+og,null); _PT.Charco.SetTile(tilePos+og,null); if(bypass){_MM.SpreadEffectLimit(tilePos.x,tilePos.y,2,0,5,0,lock_);} break;
                        case 15: AddEffectAct(7,og,bypass,lock_,11,3,null,null,2,2,direction,1); break;//tileEffect=11; tileFadeEffect=3;_PT.Gas.SetTile(tilePos+og,null); _PT.Charco.SetTile(tilePos+og,null); if(bypass){_MM.SpreadEffectLimit(tilePos.x,tilePos.y,2,0,5,0,lock_);} break;
                    }} break;
            case 3:
                    if(tileEffect!=16){
                    switch(tileEffect){
